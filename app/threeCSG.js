...
export default class ThreeBSP {
    ...
    toGeometry(unapplyTransform = true) {
        var i, j,
            matrix = unapplyTransform ? new THREE.Matrix4().getInverse(this.matrix) : null,
        ...
        for (i = 0; i < polygon_count; i++) {
            ...
            for (j = 2; j < polygon_vertice_count; j++) {
                ...
                if (unapplyTransform) vertex.applyMatrix4(matrix);
    ...
    toMesh(material, unapplyTransform = false) {
        var geometry = this.toGeometry(unapplyTransform),
            mesh = new THREE.Mesh(geometry, material);

        if (unapplyTransform) {
          mesh.position.setFromMatrixPosition(this.matrix);
          mesh.rotation.setFromRotationMatrix(this.matrix);
          mesh.scale.setFromMatrixScale(this.matrix);
        }
